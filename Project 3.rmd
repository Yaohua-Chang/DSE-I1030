...
## Question 1
Use subset selection methods to find the best 𝜆! and 𝜆! in equation (1).  
Since there are only 2 variables, 𝑇!! and 𝑇!! , exhaustive search is an appropriate method.  
```{r}
# Question 1
...
Compare with Lasso and Ridge results. What is the best model obtained according Cp, AIC, BIC, and adjusted R2?   
...
##Question 6
When the number of features used in a model increases, the training error will necessarily decrease, but the test error may not.   
